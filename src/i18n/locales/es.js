...
const es = {
  translation: {
    ...
    settingsPage: {
      header: {
        title: 'Configuracion',
        subtitle: 'Plan, empresa y preferencias',
        actions: {
          reload: 'Recargar',
      ...
      states: {
        empty: 'No se devolvio informacion de configuracion.',
      },
      errors: {
      ...
      plan: {
        ...
        labels: {
          ...
          year: 'Ano',
          oneTime: 'Pago unico',
          unknownInterval: 'Ciclo no informado',
          noPrice: 'Precio no informado',
          trialEnds: 'Fin del trial',
          nextCharge: 'Proximo cobro',
          periodEnds: 'Termina el',
          periodFallback: 'Periodo',
          noDate: 'Sin fecha',
          limits: 'Limites del plan',
          nextAction: 'Proxima accion',
          trialDays: 'Dias de trial restantes',
          billingDays: 'Dias hasta facturacion',
          cancelAtPeriodEnd: 'Cancelar al final del ciclo',
          endsAt: 'La suscripcion termina el',
          yes: 'Si',
          no: 'No',
        },
        usage: {
          ...
          overLimit: 'Sobre el limite',
          percent: '{{percent}}% de la capacidad',
        },
        actions: {
      ...
      company: {
        title: 'Empresa',
        subtitle: 'Datos basicos de la organizacion.',
        unknown: 'Empresa',
        fields: {
          name: 'Nombre',
          country: 'Pais',

...
const ptBR = {
  translation: {
    ...
    settingsPage: {
      header: {
        title: 'Configurações',
        subtitle: 'Plano, empresa e preferências',
        actions: {
          reload: 'Recarregar',
      ...
      states: {
        empty: 'Nenhuma informação de configurações foi retornada.',
      },
      errors: {
        load: 'Não foi possível carregar as configurações.',
        forbidden: 'Seu perfil não possui acesso a dados de configuração.',
      ...
      plan: {
        ...
        labels: {
          ...
          unknownInterval: 'Intervalo não informado',
          noPrice: 'Preço não informado',
          trialEnds: 'Fim do período de testes',
          nextCharge: 'Próxima cobrança',
          periodEnds: 'Termina em',
          periodFallback: 'Período',
          noDate: 'Sem data',
          limits: 'Limites do plano',
          nextAction: 'Próxima ação',
          trialDays: 'Dias de teste restantes',
          billingDays: 'Dias até faturamento',
          cancelAtPeriodEnd: 'Cancelar ao fim do ciclo',
          endsAt: 'Assinatura termina em',
          yes: 'Sim',
          no: 'Não',
        },
        usage: {
          withLimit: '{{current}} de {{limit}} colaboradores',
          withoutLimit: '{{current}} colaboradores',
          overLimit: 'Acima do limite',
          percent: '{{percent}}% da capacidade',
        },
        actions: {
          portal: 'Portal do cliente',
          portalDisabled: 'Portal indisponível',
      ...
      company: {
        title: 'Empresa',
        subtitle: 'Dados básicos da organização.',
        unknown: 'Empresa',
        fields: {
          name: 'Nome',
          country: 'País',
      ...
      preferences: {
        title: 'Preferências',
        subtitle: 'Timezone e idioma da empresa.',
        helper: 'Aplicado a filtros, horários e exportações.',
        fields: {
          timezone: 'Timezone da empresa',
          locale: 'Idioma',
        ...
        states: {
          ...
          noTimezone: 'Nenhum timezone configurado.',
        },
        toast: {
      ...
      security: {
        ...
        subtitle: 'Controles essenciais da conta.',
        helper: 'Status retornados pela API.',
        fields: {
          twoFactor: '2FA habilitado',
          lastLogin: 'Último login',
          logRetention: 'Retenção de logs (dias)',
          exportEnabled: 'Exportação habilitada',
        },
        labels: {
          enabled: 'Ativado',
          disabled: 'Desativado',
      ...
      advanced: {
        ...
        subtitle: 'IDs técnicos e URLs',
        helper: 'Use somente se precisar copiar informações de billing.',
        planSlug: 'Slug do plano',

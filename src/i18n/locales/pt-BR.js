...
const ptBR = {
  translation: {
    ...
    settingsPage: {
      badge: 'Admin',
      title: 'Configurações',
      subtitle: 'Plano atual e preferências essenciais da empresa.',
      loading: 'Carregando...',
      errors: {
        noCompany: 'Nenhuma empresa vinculada ao usuário.',
        load: 'Não foi possível carregar a assinatura atual.',
      ...
      plan: {
        ...
        empty: 'Nenhuma informação de plano encontrada.',
        statusLabel: 'Status: {{status}}',
        trialEnds: 'Trial ate {{date}}',
        renews: 'Renova em {{date}}',
      },
      limits: {
        maxEmployees: 'Funcionarios',
      },
      security: {
        title: 'Segurança',
        ...
        sessionsHint: 'Revogue sessões suspeitas ou expirada.',
      },
      preferences: {
        notifications: 'Alertas',
        title: 'Notificações e alertas',
        email: 'Avisos por e-mail',
        emailHint: 'Receber notificações operacionais e de cobranca.',
        reminders: 'Lembretes de ponto',
        remindersHint: 'Alertar colaboradores sobre batidas e intervalos.',
        reports: 'Relatórios automaticos',
        reportsHint: 'Enviar resumo semanal de jornadas para gestores.',
        critical: 'Segurança',
        criticalTitle: 'Acesso administrativo',
        criticalDescription: 'Gerencie quem pode administrar billing, planos e configurações sensiveis.',
      },
      actions: {
        manage: 'Gerenciar',
        view: 'Ver',
